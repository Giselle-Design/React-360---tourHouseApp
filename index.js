...
import {
  ...
  Text,
  View,
  VrButton, // The way of changing state of componenet once the state has been changed we rendering and update the state
} from 'react-360';
import house from './data/houseData';

export default class TourHouse extends React.Component {
  state = {
...
AppRegistry.registerComponent('TourHouse', () => TourHouse);
